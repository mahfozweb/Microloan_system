                        ...
                        <div className="flex flex-col min-h-screen">
                            ...
                            <main className="flex-grow">
                                <Routes>
                                    ...
                                    <Route path="/dashboard/all-loans" element={
                                        <PrivateRoute allowedRoles={['admin']}>
                                            <AdminAllLoans />
                                        </PrivateRoute>
                                    } />
                                    <Route path="/dashboard/loan-applications" element={
                                        <PrivateRoute allowedRoles={['admin']}>
                                            <LoanApplications />
                                        </PrivateRoute>
                                    } />
                                    ...
                                    {/* Manager Routes */}
                                    <Route path="/dashboard/add-loan" element={
                                        <PrivateRoute allowedRoles={['manager', 'admin']}>
                                            <AddLoan />
                                        </PrivateRoute>
                                    } />
                                    <Route path="/dashboard/manage-loans" element={
                                        <PrivateRoute allowedRoles={['manager', 'admin']}>
                                            <ManageLoans />
                                        </PrivateRoute>
                                    } />
                                    <Route path="/dashboard/pending-loans" element={
                                        <PrivateRoute allowedRoles={['manager', 'admin']}>
                                            <PendingLoans />
                                        </PrivateRoute>
                                    } />
                                    <Route path="/dashboard/approved-loans" element={
                                        <PrivateRoute allowedRoles={['manager', 'admin']}>
                                            <ApprovedLoans />
                                        </PrivateRoute>
                                    } />
                                    ...
                                    {/* Borrower Routes */}
                                    <Route path="/dashboard/my-loans" element={
                                        <PrivateRoute allowedRoles={['borrower']}>
                                            <MyLoans />
                                        </PrivateRoute>
                                    } />
                                    <Route path="/dashboard/borrower-profile" element={
                                        <PrivateRoute allowedRoles={['borrower']}>
                                            <BorrowerProfile />
                                        </PrivateRoute>
                                    } />
